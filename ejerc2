...
# Definir la matriz A y el vector b según el sistema de ecuaciones dado
A = np.array([
    [20, -5, -3, 0, 0],
    [-4, 18, -2, -1, 0],
    [-3, -1, 22, -5, 0],
    [0, -2, -4, 25, -1],
    [0, 0, 0, 0, 1]  # Asumiendo que T5 no está acoplado con otros puntos
])

b = np.array([100, 120, 130, 150, 0])  # Asumiendo que T5 no tiene fuente de calor
